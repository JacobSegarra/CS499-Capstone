...
import com.example.fitnessapp.ui.WeightAdapter;
...
public class DashboardActivity extends AppCompatActivity implements WeightAdapter.OnItemActionListener {
    ...
    private void setupFab() {
        binding.fabAddEntry.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, com.example.fitnessapp.ui.AddEntryActivity.class);
            intent.putExtra(com.example.fitnessapp.ui.AddEntryActivity.EXTRA_USER_ID, currentUserId);
    ...
    public void onEditClick(WeightEntry entry) {
        Intent intent = new Intent(this, com.example.fitnessapp.ui.AddEntryActivity.class);
        intent.putExtra(com.example.fitnessapp.ui.AddEntryActivity.EXTRA_USER_ID, currentUserId);
        intent.putExtra(com.example.fitnessapp.ui.AddEntryActivity.EXTRA_ENTRY_JSON,
